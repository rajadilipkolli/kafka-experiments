...
class KafkaDeadLetterPublishingApplicationTests {
        ...
        assertThrows(
                ...
                () ->
                        KafkaTestUtils.getSingleRecord(
                                kafkaConsumer, ORDERS_DLT, Duration.ofSeconds(5)),
    ...
    void should_produce_onto_dlt_for_bad_message() throws Exception {
        ...
        ConsumerRecord<String, String> record =
                KafkaTestUtils.getSingleRecord(kafkaConsumer, ORDERS_DLT, Duration.ofSeconds(2));
        ...
        assertThat(record.value())
                .isEqualToIgnoringWhitespace(
                        """
				{ "orderId": "%s", "articleId": "%s", "amount":-2 }"""
                                .formatted(order.orderId(), order.articleId()));
    }
}
